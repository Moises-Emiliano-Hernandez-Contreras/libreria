...
@section("title","Cliente - Sistema de Biblioteca ")
...
<section class="full-box dashboard-contentPage">
    ...
    @include("layouts.nav")   
		<!-- Content page -->
		@include("layouts.client-partials")
		<!-- Panel nuevo cliente -->
				    			...
				    			<div class="row">
				    				...
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	...
										  	<input class="form-control" type="password" name="password2_reg" required="" maxlength="70">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-12 col-sm-6">
													...
													<p class="text-left">
														<div class="label label-info">Nivel 4</div> Estudiante
													</p>													
												</div>
												<div class="col-xs-12 col-sm-6">
													<div class="radio radio-primary">
													...
													<div class="radio radio-primary">
														<label>
															<input type="radio" name="optionsPrivilegio" id="optionsRadios3" value="4" checked="">
															<i class="zmdi zmdi-star"></i> &nbsp; Nivel 4
														</label>
													</div>
												</div>
											</div>
