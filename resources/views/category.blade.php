                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                          ...
                                          <input pattern="[0-9]{1,7}" class="form-control" type="text" name="code" required="" maxlength="7">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                          <label class="control-label">Nombre *</label>
                                          <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="name" required="" maxlength="30">
                                    </div>
                                </div>
                            </div>
                        </div>
